...
const (
	...
	UserService_RefreshGrpcToken_FullMethodName = "/gateway.UserService/RefreshGrpcToken"
)
...
type UserServiceClient interface {
	...
	RefreshGrpcToken(ctx context.Context, in *RefreshGrpcTokenRequest, opts ...grpc.CallOption) (*RefreshGrpcTokenResponse, error)
}
...
func (c *userServiceClient) RefreshGrpcToken(ctx context.Context, in *RefreshGrpcTokenRequest, opts ...grpc.CallOption) (*RefreshGrpcTokenResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(RefreshGrpcTokenResponse)
	err := c.cc.Invoke(ctx, UserService_RefreshGrpcToken_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type UserServiceServer interface {
	...
	RefreshGrpcToken(context.Context, *RefreshGrpcTokenRequest) (*RefreshGrpcTokenResponse, error)
...
func (UnimplementedUserServiceServer) RefreshGrpcToken(context.Context, *RefreshGrpcTokenRequest) (*RefreshGrpcTokenResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method RefreshGrpcToken not implemented")
}
...
func _UserService_RefreshGrpcToken_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(RefreshGrpcTokenRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(UserServiceServer).RefreshGrpcToken(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: UserService_RefreshGrpcToken_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UserServiceServer).RefreshGrpcToken(ctx, req.(*RefreshGrpcTokenRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var UserService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "RefreshGrpcToken",
			Handler:    _UserService_RefreshGrpcToken_Handler,
		},
	},
	Streams:  []grpc.StreamDesc{},
	Metadata: "api/proto/proto/gateway.proto",
}
